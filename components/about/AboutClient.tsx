...
import { Instagram, Facebook, MapPin, Clock, Mail, Users } from "lucide-react"
...
export default function AboutClient({
  ...
  return (
    <main className="w-full bg-ink">
      ...
      {/* ━━━ MEET THE TEAM ━━━ */}
      {(meetTheTeam.photo_url || meetTheTeam.description) && (
        <section className="py-24 px-6">
          <div className="max-w-5xl mx-auto">
            <FadeInOnScroll direction="none">
              <div className="flex items-center mb-16">
            ...
            <FadeInOnScroll direction="up" delay={0.1}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                {/* Team Photo */}
                {meetTheTeam.photo_url && (
                  <div className="relative aspect-[4/3] overflow-hidden bg-[#1a1a1a]">
                    <Image
                      src={meetTheTeam.photo_url}
                      alt={meetTheTeam.heading}
                      fill
                ...
                {/* Team Info */}
                <div className={meetTheTeam.photo_url ? "" : "md:col-span-2"}>
                  <div className="flex items-center gap-3 mb-4">
                    <Users className="w-5 h-5 text-psy-green" />
